  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 60% at 50% 30%, rgba(0,212,255,0.07), transparent)',
        }}
      />
      ...
      <div className="w-full max-w-sm">
        ...
        {/* Trust badges */}
        <div className="mb-6 flex items-center justify-center gap-4 text-xs" style={{ color: 'var(--text-muted)' }}>
          {['14-day trial', 'No setup fees', 'Cancel anytime'].map((b) => (
        ...
        >
          {/* Google OAuth */}
          <button
            className="flex h-11 w-full items-center justify-center gap-3 rounded-xl text-sm font-semibold transition-all hover:bg-white/5"
